...
import messagesResolvers from './messages/message.resolvers';
import messagesTypeDefs from './messages/message.typeDefs';
import commentsResolvers from './comments/comments.resolvers';
import commentsTypeDefs from './comments/comments.typeDefs';
export const typeDefs = [userProfileTypeDefs, photosModelTypeDefs, userLoginTypeDefs, userSignUpTypeDefs, followModelTypeDefs, editphotosModelTypeDefs, messagesTypeDefs, commentsTypeDefs];
export const resolvers = [userProfileResolvers, photosModelResolvers, userLoginResolvers, userSignUpResolvers, followModelResolvers, editphotosModelResolvers, messagesResolvers, commentsResolvers];
