...
export const typeDefs = [userProfileTypeDefs, photosModelTypeDefs, userLoginTypeDefs, userSignUpTypeDefs, followModelTypeDefs, editphotosModelTypeDefs, messagesTypeDefs];
export const resolvers = [userProfileResolvers, photosModelResolvers, userLoginResolvers, userSignUpResolvers, followModelResolvers, editphotosModelResolvers, messagesResolvers];
